...
liste_genres = ['Action', 'Actualités', 'Animation', 'Aventure', 'Biographie',
       'Comédie', 'Comédiemusicale', 'Crime', 'Documentaire', 'Drame',
    ...
    if requete2 == 1 :
      ...
      if len(filmo) == 0 :
        ...
        with col8: 
          if len(filmo) >= 8 :
            st.write(filmo[7])
            st.image(searchMovies(affiche[7]), use_columnuse_container_width _width=True)
